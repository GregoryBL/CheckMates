...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var coreDataStack = CoreDataStack(modelName: "CheckMates")
...
//        UITabBarItem.appearance().setTitleTextAttributes([NSForegroundColorAttributeName: UIColor.white], for:UIControlState())
        ...
        UINavigationBar.appearance().barTintColor = UIColor(hexString: "#0190FB")
...
//        tabBarConroller.selectedIndex = 1
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.checkmatesapp.CheckMates" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "CheckMates", withExtension: "momd")!
